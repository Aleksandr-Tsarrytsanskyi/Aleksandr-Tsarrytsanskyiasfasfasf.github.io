document.addEventListener("DOMContentLoaded", init);
 ...
 function init() {
  ...
  const aboutUsTexts = {
    ...
    servicetext2: {
      ua: "Наш штат включає ліцензованих інженерів та співробітників. <br>Взаємодія з клієнтом базується на <br>чесному та прозорому спілкуванні.",
      de: "Zu unserem Personal gehören lizenzierte Ingenieure und Angestellte.<br> Die Interaktion mit dem Kunden basiert auf ehrlicher und <br>transparenter Kommunikation.",
      pl: "Nasz personel obejmuje licencjonowanych inżynierów i pracowników.<br> Interakcja z klientem opiera się na uczciwej i<br> przejrzystej komunikacji.",
      en: "Our staff includes licensed engineers and employees.<br> Interaction with the client is based on honest and <br>transparent communication.",
    },
    servicetext3: {
      ua: "Політика компанії спрямована на <br>постійне вдосконалення технологій і методів ремонту.",
      de: "Die Unternehmenspolitik zielt auf eine <br>ständige Verbesserung der Reparaturtechnologien und -methoden ab.",
      pl: "Polityka firmy ukierunkowana jest na <br>ciągłe doskonalenie technologii i metod napraw.",
